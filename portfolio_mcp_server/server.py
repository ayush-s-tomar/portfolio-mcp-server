...
PROJECTS: list[dict] = [
    {
        ...
        "demo": "https://salesagent-ai.streamlit.app/",
    ...
    },
    {
        ...
        "demo": "https://ai-inbox-agent.streamlit.app/",
        "writeup": None,
        "flagship": False,
    },
    {
        ...
        "demo": "https://aria-bot.streamlit.app/",
        "writeup": None,
        "flagship": False,
    },
    {
...
def main() -> None:
    """Entry point used by the `portfolio-mcp-server` console script."""
